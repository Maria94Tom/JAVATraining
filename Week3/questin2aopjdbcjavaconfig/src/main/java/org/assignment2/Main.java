...
public class Main {
    public static void main(String[] args) {
       ...
       // Add new employees
        System.out.println("Added Employee: " + employeeService.addEmployee(new Employee("Raj", "IT", 600000)));
        System.out.println("Added Employee: " + employeeService.addEmployee(new Employee("Ekta", "IT", 500000)));
      ...
      //  Delete an employee
       ...
       //  Add a new employee
        Employee newEmployee = new Employee( "John", "HR", 8000000);
